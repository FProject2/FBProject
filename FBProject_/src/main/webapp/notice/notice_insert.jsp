        ...
        <div class="board_write_wrap">
            <div class="board_write">
                ...
                <div class="info">
                    <dl style="width: 40%">
                        <dt>글쓴이</dt>
                        <dd><input type="text" name="name" placeholder="글쓴이 입력" value="${sessionScope.id }" readonly></dd>
                    </dl>
                    <dl style="width: 30%">
                        <dt>카테고리</dt>
                        <dd><select name="ncno" style="width: 95px;height: 30px;">
                    ...
                    <dl style="width: 30%">
                     <dt>고정글</dt>
  						...
  						<input type="checkbox" name="fix" value="1" id="input_check">
